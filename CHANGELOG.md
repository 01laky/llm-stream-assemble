...
- **CI docs positioning** — frozen **DOC235** pins CHANGELOG policy instead of gitignored `.cursor/rules` files.

### Changed

- **CHANGELOG** — full release history consolidated into this file; removed `CHANGELOG-archive.md`.
